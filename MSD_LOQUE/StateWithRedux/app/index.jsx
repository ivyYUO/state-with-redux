    ...
    <View style={[styles.container, isTablet && styles.containerTablet]}>
      <View style={{
        ...
        <View style={{
          ...
          <Avatar.Icon size={40} icon="check-circle" style={{ backgroundColor: '#fff', marginRight: 12 }} />
          <View style={{ flex: 1 }}>
            <Text style={{ fontWeight: 'bold', fontSize: 12, color: '#fff', marginBottom: 12, margin: 10 }}>Redux Todo Demo</Text>
            <Text style={{ fontSize: 14, color: '#e0f2f1' }}>Active & Done Cards</Text>
          </View>
  ...
  return (
    <Card style={styles.card}>
      ...
      <Card.Content>
            ...
            editingId === item.id ? (
              ...
              <Card style={{ flex: 1, marginRight: numColumns > 1 ? 8 : 0 }}>
                ...
                <Card.Actions>
                  ...
                  }} style={{ backgroundColor: '#d32f2f' }} textColor="#fff">
                    Remove
                  </Button>
                </Card.Actions>
              </Card>
        ...
        />
        {items.length > 0 && (
          <Button style={{ marginTop: 8 }} onPress={() => {
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#a5d6a7" }, // light green
